        ...
        <div className="max-w-sm w-full mx-auto animate-fade-up">
          ...
          >
            ...
            <div className="flex justify-between text-sm">
              ...
              <button type="button" className="text-saffron-deep font-medium hover:underline">Forgot?</button>
            </div>
          ...
          <p className="text-sm text-center text-muted-foreground mt-8">
            New here? <Link to="/register" className="text-saffron-deep font-semibold hover:underline">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      {brand === "Google" ? (
        ...
        <svg viewBox="0 0 24 24" className="h-4 w-4 fill-foreground"><path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.56v-2c-3.2.7-3.88-1.36-3.88-1.36-.52-1.34-1.28-1.7-1.28-1.7-1.05-.71.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.7 1.26 3.36.96.1-.75.4-1.26.73-1.55-2.55-.29-5.24-1.28-5.24-5.7 0-1.26.45-2.29 1.19-3.1-.12-.29-.52-1.47.11-3.06 0 0 .97-.31 3.18 1.18.92-.26 1.91-.39 2.89-.39.98 0 1.97.13 2.89.39 2.21-1.49 3.18-1.18 3.18-1.18.63 1.59.23 2.77.11 3.06.74.81 1.19 1.84 1.19 3.1 0 4.43-2.7 5.41-5.27 5.69.41.36.78 1.06.78 2.13v3.16c0 .31.21.68.8.56C20.21 21.39 23.5 17.08 23.5 12 23.5 5.65 18.35.5 12 .5z"/></svg>
      )}
      {brand}
    </button>
  );
